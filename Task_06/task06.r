...
# lines 23-27 are the new graph with the combination of n, h, and s that best match the empirical data. This graph is comparable to the actual scrub jay population using n=1000, h=1, and s=0. 